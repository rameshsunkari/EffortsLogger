...
public class MessageUtility {
	...
	public static void addSuccessMessage(String msg_name) {
		String msg = ResourceBundle.getBundle("com.efforts.messages.Message")
				.getString(msg_name);
	...
	public static Object getObjectFromRequestParameter(
		...
		String theId = MessageUtility.getRequestParameter(requestParameterName);
