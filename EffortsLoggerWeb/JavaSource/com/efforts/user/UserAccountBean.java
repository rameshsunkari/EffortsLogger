...
public class UserAccountBean {
	...
	public void init() {
		...
		for (ProjectInfo project : projectList) {
			projectItemList.add(new SelectItem(project.getId(), project.getName()));
		}
	...
	public String addMember() {
		...
		String managerName = newUser.getManagerInfo().getFname() + " " + newUser.getManagerInfo().getLname();
		Object[] msgParams = new Object[] {userName,newUser.getRolesInfo().getName(), newUser.getProjectInfo().getName(), managerName };
		MailUtil.sendMessage(newUser.getMailid(), newUser.getManagerInfo().getMailid(), "add_member_subject", new Object[]{userName}, "add_member_content", msgParams );
		MessageUtility.addErrorMessage("user_add_success");
